(function () {
  ...
  function render(message) {
    ...
    panel.innerHTML = '<b>Signed in</b><div style="color:#91a3ba;margin-top:4px">' + state.user.email + '</div><div style="margin-top:6px"><a href="account.html" style="color:#9bc3ff">Household</a> | <a href="postage.html" style="color:#9bc3ff">Postage</a> | <a href="admin.html" style="color:#9bc3ff">Review queue</a></div><button id="npnPush" style="margin-top:7px;padding:5px">Enable push</button><button id="npnSignOut" style="margin:7px 0 0 5px;padding:5px">Sign out</button>';
